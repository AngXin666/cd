...
- **普通管理端**：管理员工作台、司机管理、基础管理功能、管辖仓库计件管理
- **超级管理端**：超级管理员控制台、系统管理、用户权限管理、仓库管理、考勤规则配置、司机仓库分配、管理员仓库分配、计件品类管理
...
- **计件录入**（管理员）：录入计件数据，包含件数、单价、品类、是否需要上楼、上楼单价等字段
- **权限控制**：普通管理员仅能查看和管理其管辖仓库范围内的计件数据，超级管理员可查看和管理全部仓库计件数据
