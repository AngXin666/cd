...
本项目实现了统一的热更新系统，支持不同平台的自动更新：

#### 微信小程序
- **更新方式**：使用微信官方 `wx.getUpdateManager()` API
- **更新时机**：应用启动时自动检查
- **用户体验**：有新版本时弹窗提示用户重启应用
- **无需配置**：微信平台自动管理版本

#### Android APP
- **更新方式**：使用 Capacitor LiveUpdate 插件
- **版本管理**：从 Supabase 数据库获取版本信息
- **更新内容**：H5 代码热更新（无需重新安装 APK）
- **更新类型**：
  - 可选更新：用户可以选择稍后更新
  - 强制更新：必须更新才能继续使用
- **用户体验**：显示版本号、更新说明和下载进度

#### H5 网页版
- **更新方式**：浏览器自动加载最新代码
- **无需热更新**：刷新页面即可获取最新版本

**详细配置和测试指南**：查看 [热更新系统文档](./docs/unified-hot-update/)
...
> **📋 完整文档索引**: [DOCS-INDEX.md](./DOCS-INDEX.md) - 查找所有项目文档

### 核心文档
- [📖 项目 Wiki](./WIKI.md) - 完整技术文档（系统概览、技术架构、数据库设计、API文档、开发指南）
- [🚀 H5 部署指南](./DEPLOY-NOW.md) - H5 热更新部署说明
...
### 系统文档
- [权限系统文档](./docs/权限系统/) - 权限系统技术实现和使用指南
- [系统核心文档](./docs/系统核心/) - 核心业务功能文档
...
- 📱 [车队管家-v1.2.3-渐变背景.apk](./车队管家-v1.2.3-渐变背景.apk)

**历史版本**: 已归档到 `archive/` 目录，详见 [archive/README.md](./archive/README.md)
