...
from tests.factories import (
    ...
    NotificationFactory, VersionFactory
)
from tests.helpers import (
    get_auth_headers, assert_success_response,
    create_test_token, login_user
)
...
class TestFactories:
    ...
    def test_version_factory(self, session: Session):
        """测试版本工厂"""
        version = VersionFactory.create(session, version="1.0.0")
        
        assert version.version == "1.0.0"
        assert version.version_code == 10000
