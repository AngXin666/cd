...
export function useBehaviorTracker() {
  return {
    ...
    trackAction: (featureModule: FeatureModule | string, actionType: ActionType, pagePath?: string) =>
      behaviorTracker.trackAction(featureModule, actionType, pagePath),
    getHighPriorityFeatures: (limit?: number) => behaviorTracker.getHighPriorityFeatures(limit),
    getAllFeatureWeights: () => behaviorTracker.getAllFeatureWeights(),
    getFeatureCacheTTL: (featureModule: string) => behaviorTracker.getFeatureCacheTTL(featureModule)
  }
}
