...
BEGIN
  ...
  EXECUTE 'CREATE TEMP TABLE bak_warehouses AS SELECT id, name, created_at, updated_at FROM warehouses';
  ...
  EXECUTE 'INSERT INTO warehouses (id, name, created_at, updated_at)
    SELECT id, name, created_at, updated_at FROM bak_warehouses ON CONFLICT (id) DO NOTHING';
