...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE '✅ 自动停用过期租户函数已创建';
  RAISE NOTICE '========================================';
  RAISE NOTICE '使用方法：';
  RAISE NOTICE '  SELECT disable_expired_tenants();';
  RAISE NOTICE '';
  RAISE NOTICE '停用规则：';
  RAISE NOTICE '  - 老板账号（super_admin）：停用';
  RAISE NOTICE '  - 平级账号（super_admin）：停用';
  RAISE NOTICE '  - 车队长（admin）：停用';
  RAISE NOTICE '  - 司机（driver）：不停用';
  RAISE NOTICE '========================================';
END $$;