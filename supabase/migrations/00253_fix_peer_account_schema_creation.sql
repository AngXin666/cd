...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE '✅ 触发器已更新：排除平级账号';
  RAISE NOTICE '========================================';
  RAISE NOTICE '规则：';
  RAISE NOTICE '1. 主账号（main_account_id IS NULL）→ 创建独立 Schema';
  RAISE NOTICE '2. 平级账号（main_account_id IS NOT NULL）→ 不创建 Schema，使用主账号的 Schema';
  RAISE NOTICE '========================================';
END $$;