...
DROP FUNCTION IF EXISTS can_access_warehouse(uuid, uuid);
...
DROP FUNCTION IF EXISTS get_manager_warehouse_ids(uuid);
...
DROP FUNCTION IF EXISTS is_driver_of_warehouse(uuid, uuid);
...
DROP FUNCTION IF EXISTS is_manager_of_warehouse(uuid, uuid);
...
DROP FUNCTION IF EXISTS is_manager_of_driver(uuid, uuid);
