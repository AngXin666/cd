...
-- 删除旧函数
DROP FUNCTION IF EXISTS public.can_view_user(uuid, uuid);
DROP FUNCTION IF EXISTS public.can_manage_user(uuid, uuid);
DROP FUNCTION IF EXISTS public.has_full_permission(uuid);
