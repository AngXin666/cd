...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE '✅ 账号状态检查函数已创建';
  RAISE NOTICE '========================================';
  RAISE NOTICE '使用方法：';
  RAISE NOTICE '  SELECT check_account_status(''用户UUID'');';
  RAISE NOTICE '';
  RAISE NOTICE '返回值：';
  RAISE NOTICE '  - can_login: 是否可以登录';
  RAISE NOTICE '  - status: 账号状态';
  RAISE NOTICE '  - message: 提示信息';
  RAISE NOTICE '  - role: 用户角色';
  RAISE NOTICE '========================================';
END $$;