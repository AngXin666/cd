...
-- 考勤记录：按租户、用户、日期查询
CREATE INDEX IF NOT EXISTS idx_attendance_boss_user_date 
...
-- 请假申请：按租户、申请人、状态查询
CREATE INDEX IF NOT EXISTS idx_leave_applications_boss_user_status 
...
-- 请假申请：按租户、审批人、状态查询
CREATE INDEX IF NOT EXISTS idx_leave_applications_boss_reviewer_status 
...
-- 离职申请：按租户、申请人、状态查询
CREATE INDEX IF NOT EXISTS idx_resignation_applications_boss_user_status 
...
-- 离职申请：按租户、审批人、状态查询
CREATE INDEX IF NOT EXISTS idx_resignation_applications_boss_reviewer_status 
...
-- 计件记录：按租户、用户、日期查询
CREATE INDEX IF NOT EXISTS idx_piece_work_records_boss_user_date 
...
-- 反馈：按租户、提交人、状态查询
CREATE INDEX IF NOT EXISTS idx_feedback_boss_user_status 
