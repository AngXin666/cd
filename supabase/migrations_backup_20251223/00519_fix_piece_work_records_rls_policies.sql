...
-- 1. 更新 is_boss 函数，使用新的 user_roles 表
...
-- 4.1 管理员（BOSS, MANAGER, DISPATCHER）可以查看所有计件记录
...
-- 4.2 管理员（BOSS, MANAGER, DISPATCHER）可以创建计件记录
...
-- 4.3 管理员（BOSS, MANAGER, DISPATCHER）可以更新所有计件记录
...
-- 4.4 管理员（BOSS, MANAGER, DISPATCHER）可以删除所有计件记录
