/*
# 修复 insert_tenant_profile 函数 - 移除角色类型转换
...
-- 授予执行权限
GRANT EXECUTE ON FUNCTION public.insert_tenant_profile(TEXT, UUID, TEXT, TEXT, TEXT, TEXT) TO authenticated;
