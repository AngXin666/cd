...
## 新表结构
- users, user_roles (BOSS/DISPATCHER/DRIVER), departments, warehouses, vehicles, attendance, leave_requests, piecework_records, notifications
*/
...
BEGIN
  -- 1. 创建临时表备份数据
  EXECUTE 'CREATE TEMP TABLE bak_profiles AS SELECT * FROM profiles';
