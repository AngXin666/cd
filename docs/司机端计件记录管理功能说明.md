...
#### 3.2.3 快捷筛选
为了方便用户快速选择常用的日期范围，系统提供了三个快捷筛选按钮：
...
##### 视觉反馈
- **未选中状态**：浅色渐变背景（蓝色/绿色/橙色 50-100）
- **选中状态**：深色渐变背景（蓝色/绿色/橙色 600-500）+ 白色文字 + 阴影效果
- **点击效果**：缩小动画（scale-95）

##### 自定义日期
- 当用户手动修改开始日期或结束日期时，快捷筛选状态自动切换为"自定义"
- 所有快捷按钮恢复为未选中状态
...
- ✏️ **灵活管理**：支持编辑和删除历史记录
- 🔍 **精准筛选**：支持按仓库和日期范围筛选
- ⚡ **快捷操作**：提供前一天、本周、本月快捷筛选按钮
- 📅 **清晰展示**：醒目的日期时间显示和详细的数据明细
