...
### 3.4 用户信息管理优化
- **管理员页面用户信息显示**
  - **超级管理员和普通管理员页面**：隐藏用户邮箱信息
  - **编辑实名按钮**：在用户信息区域添加「编辑实名」按钮

- **用户信息编辑功能**
  - **创建编辑页面**：开发用户信息编辑页面
  - **编辑内容**：支持姓名、电话信息的编辑
  - **权限管理**：普通管理员可编辑自己的姓名和电话

- **通知机制**
  - **普通管理员编辑后通知**：普通管理员编辑个人信息后，自动通知超级管理员
  - **通知方式**：通过系统消息或应用内通知发送
...
### 5.3 用户信息管理技术实现
- **用户信息显示控制**
  - 根据用户角色动态控制邮箱字段的显示/隐藏
  - 超级管理员和普通管理员页面不显示邮箱信息

- **编辑功能实现**
  - 创建用户信息编辑页面，包含姓名、电话输入框
  - 权限验证：普通管理员只能编辑本人信息
  - 数据验证：手机号码格式校验
