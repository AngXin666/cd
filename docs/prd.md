...
- **功能gps**
  ...
  - 实现车辆管理端与管理端的状态协同，提供清晰的流程追踪
  - 支持图片锁定与删除功能，提升审核效率和信息质量

- **适用范围**
  - 车辆管理端〔我的车辆〕模块
  - 管理端〔车辆管理〕模块下的〔车辆信息审核〕专属页面
  - 所有管理员和超级管理员

### 2.2 车辆管理端功能需求
#### 2.2.1 车辆录入功能
- **录入场景**
  - **提车录入场景**：管理员首次添加车辆信息，包含车辆基本信息、行驶证拍照识别、车辆实体验证拍照等
  - **还车录入场景**：管理员还车车辆时，拍摄还车照片并填写还车说明
...
- **补录触发条件**
  ...
  - 数据库自动将车辆状态更新为〔需补录〕
  - 数据库自动记录需补拍的图片项（如〔车辆正面照〕〔车辆侧面照〕等）

- **补录操作流程**
  - **步骤1：查看补录要求**
    + 管理员进入车辆详情页面，数据库显示需补录的图片项列表
    + 示例：〔需补录图片：车辆正面照、车辆侧面照〕
...
#### 2.3.1 车辆信息审核专属页面
- **页面位置**
  - 在管理端〔车辆管理〕模块下，创建独立的〔车辆信息审核〕专属页面
  - 页面入口：管理端首页〔车辆管理〕卡片中显示〔待审核〕数量，点击进入审核页面
...
#### 2.4.2 通知机制
- **车辆管理端通知**
  - **审核通过通知**：〔您的车辆【车牌号码】已通过审核，可进行后续操作〕
  - **需补录通知**：〔您的车辆【车牌号码】需补录图片，请尽快完成补录并重新提交〕

- **管理端通知**
  - **新增待审核通知**：〔管理员【邱吉兴】提交了车辆【车牌号码】的车辆信息，请及时审核〕
  - **重新提交审核通知**：〔管理员【邱吉兴】已完成车辆【车牌号码】的图片补录，请重新审核〕
...
#### 2.4.3 数据同步
- **实时同步**
  - 车辆管理端提交审核后，管理端立即显示待审核车辆
  - 管理端审核操作后，车辆管理端立即更新车辆状态
  - 通过WebSocket实现实时数据推送
