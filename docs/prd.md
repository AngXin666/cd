...
#### 2.2.1 车辆录入功能
- **录入场景**
  - **提车录入场景（提车）**：管理员首次添加车辆信息，包含车辆基本信息、行驶证拍照识别、车辆实体验证拍照等
...
- **录入流程**
  ...
  - **步骤3：车辆实体验证拍照（提车场景）**
    + **必须拍摄7张照片**：车辆正面、左前45度、左侧面、左后45度、后面、右后45度、右侧面
    + 照片数量要求：必须7张，不可多不可少
    + 数据库自动保存照片到〔车辆照片〕标签页
...
- **补录触发条件**
  ...
  - 数据库自动将车辆状态更新为〔需补录〕
  - 数据库自动记录需补拍的图片项（如〔车辆正面照〕〔车辆侧面照〕〔车损特写〕等）

- **补录操作流程**
  - **步骤1：查看补录要求**
    + 管理员进入车辆详情页面，数据库显示需补录的图片项列表
    + 示例：〔需补录图片：车辆正面照、车辆侧面照、车损特写照片1〕
